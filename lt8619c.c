...
void        lt8619c_loop            (void);
bool        lt8619c_check_id        (void);
void        lt8619c_init            (void);

/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
__xdata lt8619c_rxstatus    LT8619C_RXStatus, *pLT8619C_RXStatus;

__xdata uint16_t    hActive, vActive;
__xdata uint16_t    hSyncWidth, vSyncWidth;
__xdata uint16_t    hBackPorch, vBackPorch;
__xdata uint16_t    hTotal, vTotal;
__xdata uint8_t     hSyncPol, vSyncPol, Color;
__xdata uint32_t    FrameCounter;

/*---------------------------------------------------------------------------*/
// fixed edid data
const uint8_t ONCHIP_EDID[256] = {
    /*
        // 52800, 50, 50, 40, 960, 1100, 50, 20, 10, 720, 800
    ...
    */
    ...
    0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0xa0, 0x14, 0xc0, 0x8c, 0x30, 0xd0, 0x50, 0x20, 0x32, 0x32,
    0x34, 0x00, 0x80, 0x38, 0x74, 0x00, 0x00, 0x1e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x4c, 0x6f, 0x6e, 0x74, 0x69, 0x75, 0x6d, 0x20, 0x73, 0x65, 0x6d, 0x69, 0x20, 0x01, 0xa0,
